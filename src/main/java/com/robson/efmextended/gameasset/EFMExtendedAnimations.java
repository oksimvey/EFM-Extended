...
public class EFMExtendedAnimations {
    ...
    private static void build(AnimationManager.AnimationBuilder builder) {
        PUSH = builder.nextAccessor("biped/skill/push", (accessor) ->
                new AttackAnimation(0.1F, 0.0F, 0.05F, 0.1F, 0.35F,
                        ColliderPreset.FIST_FIXED, Armatures.BIPED.get().rootJoint, accessor, Armatures.BIPED)
                        .addProperty(AnimationProperty.AttackPhaseProperty.SWING_SOUND, (SoundEvent) EpicFightSounds.WHOOSH.get())
                        .addProperty(AnimationProperty.AttackPhaseProperty.PARTICLE, EpicFightParticles.HIT_BLUNT)
                        .addProperty(AnimationProperty.AttackPhaseProperty.HIT_SOUND, (SoundEvent)EpicFightSounds.BLUNT_HIT.get())
